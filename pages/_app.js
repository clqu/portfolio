        ...
        <div className="max-w-screen-lg p-5 w-full md:w-10/12 lg:w-8/12 mx-auto transition-all duration-300">
          <div className="md:flex w-full items-center justify-between">
            <div>
              ...
              <a href="https://github.com/clqu/clqu.live" target="_blank" className="hover:text-red-500 transition-all duration-200">This website is open source on GitHub.</a>
            </div>
            <div className="mt-2 md:mt-0 flex items-center">
              <a href="https://voiddevs.org/discord" target="_blank" className="w-full md:w-auto bg-neutral-700/30 hover:bg-neutral-700/50 px-4 py-2 rounded-md transition-all duration-200">
